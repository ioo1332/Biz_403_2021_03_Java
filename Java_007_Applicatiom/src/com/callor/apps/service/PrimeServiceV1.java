 ...
 * 누군가에게 test의뢰
 * 같은팀의 누군가에게 의뢰 -alpha Version
 * 외부의 다른 누군가에게 의뢰 - Beta Version
 * 
 ...
 * 기존 프로젝트를 V1이라고 하고
 * 새롭게 기능이 개선(추가)되어 배포된 프로젝트를 V2.xx라고 칭하여 배포
 */

import java.util.Random;

/*
 * main() method에서 배열을 만들고 값을 저장한다음
 * prime인가를 검사해서 출력했다
 * 이 코드를 PrimeService를 클래스를 만들고 분리해서 다시 작성
 */

// class 이름짓기
// 첫글자 대문자 이후는 camel case (Upper)CamelCase방식
//Service 클래스
//main()에 종합적으로 작성된 코드를
//nathod들을 만들어 분리하고
//코드 관리를 쉽게 하도록 만드는 클래스
public class PrimeServiceV1 {
	// 어떤 변수를 사용하여 프로젝트를 수행할것인가
	// 두개 이상의 matod에서 공통으로 사용할 변수들은
	// 변수를 사용한다==변수를참조 : 저장,읽기
	// 클래스 영역에 설정을 한다
	...
	// void 키워드를 사용하지 않는다
	// 이름이 클래스 이름과 같다
	//intNums배열을 설정(초기화,개수지정)을하여 사용할 준비
