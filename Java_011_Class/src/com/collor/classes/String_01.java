...
public class String_01 {
	...
	public static void main(String[] args) {
		...
		// 문자열은 저장한값이 같더라도 저장방법이 다르면 true가 아닐수있다
		str1 = "대한민국";
		...
		/*
		 * 문자열 변ㅅ후에 담긴 문자열이 같은가를 확인할때는 동등연산자를 사용해서는 안된다 
		 * 문자열 변수는 변수에 문자열을 저장하는 방법에 따라 다른 특성을 갖게된다 
		 * 문자열의 독특한 특성 때문에 문자열에 저장된값이 같은지 확인이 안되는경우가있다
		 * 
		 * 문자열 변수에 저장된 값이 같은가 비교를 할때는 
		 * 문자열.equals("비교대상") method를 사용해야한다
		 */
